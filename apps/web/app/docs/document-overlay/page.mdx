...
export const metadata = pageMetadata({
  description:
    "A full-screen document reader that scales up from its source card and back into it on close. Content-agnostic, with optional prev and next controls.",
  path: "/docs/document-overlay",
...
[`pagination`](/docs/pagination) footer, see the [live demo](/).
